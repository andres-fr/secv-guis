...
module. If all tests pass, and coverage PERCENTAGE is above the number
given as parameter, the script exits with 0, otherwise 1.
"""
...
if __name__ == "__main__":
    ...
    c.start()
    test_results = secv_guis_utest.run_all_tests()
    c.stop()
